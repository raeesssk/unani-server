...
router.post('/', oauth.authorise(), (req, res, next) => {
    ...
    cmd.get("pg_dump --dbname=postgresql://postgres:zeartech@localhost:5432/mizaj > ../backup/"+filename+".sql --role postgres --format=c --blobs --encoding SQL_ASCII",
    function(err, data, stderr){
        if (!err) {
	        ...
	        let mailOptions = {
	            ...
	            subject: 'backup database file Mizaj', // Subject line
